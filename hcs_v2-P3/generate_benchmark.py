#!/usr/bin/env python3
"""Génère le fichier benchmark_performance.py complet"""
import os

TARGET = r"f:\FINAL\DEFINITIF\hcs_v2-P3\hcs_studio_integrated\benchmark_performance.py"
...
print(f"Benchmark genere: {TARGET}")
print(f"Taille: {os.path.getsize(TARGET):,} bytes")
