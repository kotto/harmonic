#!/usr/bin/env python3
"""
TEST AVEC VRAIES IMAGES - VERSION CORRIGÉE
Test du système de compression harmonique avec des vraies images (sans bugs)
"""
...
def create_simple_analyzer():
    """Crée un analyseur simplifié sans bugs"""
...
def test_harmonic_compression_real_images():
    """Test complet avec des vraies images (version corrigée)"""
    ...
    try:
        ...
        # Remplacer l'analyseur par la version simplifiée
        simple_analyzer = create_simple_analyzer()
        harmonic_engine._analyze_image_characteristics = simple_analyzer.analyze
        ...
        for img_name, img_array in test_images.items():
            ...
            characteristics = simple_analyzer.analyze(img_array)
