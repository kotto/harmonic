#!/usr/bin/env python3
"""
HCS V2 API Server - Version Fonctionnelle avec tous les endpoints
"""
...
if __name__ == "__main__":
    print("🚀 Démarrage HCS V2 API Server (Version Fonctionnelle)")
    print("=" * 60)
    print("📊 Configuration:")
    ...
    print("   http://localhost:8003/api/v2/compress/image")
    print("   http://localhost:8003/api/v2/compress/video")
    print("   http://localhost:8003/api/v2/stats")
    print("   http://localhost:8003/api/v2/health")
    print("   http://localhost:8003/dashboard_fixed")
    print()
    
    uvicorn.run(
        app,
        host="0.0.0.0",
        port=8003,  # Nouveau port pour éviter les conflits
        reload=False,
        log_level="info"
    )
