...
DOMAIN_EXPANSIONS = {
    ...
    'informatique': {
        'sectors': ['INFORMATIQUE', 'TECHNOLOGIE', 'TECH', 'MATHS_APPLI', 'IA'],
        'keywords': [
            'algorithme', 'structure de données', 'complexité', 'tri', 'recherche', 'arbre',
            'graphe', 'pile', 'file', 'table de hachage', 'liste chaînée', 'récursivité',
            'programmation orientée objet', 'classe', 'héritage', 'polymorphisme', 'encapsulation',
            'python', 'javascript', 'java', 'c++', 'rust', 'go', 'typescript', 'php', 'ruby',
            'sql', 'base de données', 'postgresql', 'mysql', 'mongodb', 'redis', 'sqlite',
            'api', 'rest', 'graphql', 'http', 'tcp', 'udp', 'dns', 'websocket', 'json', 'xml',
            'git', 'github', 'gitlab', 'docker', 'kubernetes', 'aws', 'azure', 'cloud',
            'linux', 'bash', 'shell', 'terminal', 'commande', 'script', 'cron', 'daemon',
            'machine learning', 'deep learning', 'neural network', 'tensorflow', 'pytorch',
            'intelligence artificielle', 'nlp', 'computer vision', 'reinforcement learning',
            'compilation', 'interpréteur', 'bytecode', 'jit', 'garbage collector', 'mémoire',
            'thread', 'processus', 'concurrence', 'parallélisme', 'mutex', 'sémaphore',
            'design pattern', 'singleton', 'factory', 'observer', 'mvc', 'solid', 'dry',
            'sécurité', 'chiffrement', 'aes', 'rsa', 'sha', 'jwt', 'oauth', 'ssl', 'tls',
            'algorithm', 'data structure', 'binary tree', 'hash table', 'sorting', 'search',
            'bitcoin', 'ethereum', 'solidity', 'smart contract', 'web3', 'dapp', 'defi',
        ],
        'quality_filter': {
            'min_object_len': 6,
            'min_relation_len': 4,
    ...
    'mathematiques': {
        'sectors': ['MATHS_PURES', 'MATHS_APPLI', 'SCIENCES', 'PHYSIQUE_FOND', 'INFORMATIQUE'],
        'keywords': [
            'théorème', 'lemme', 'corollaire', 'conjecture', 'preuve', 'démonstration',
            'axiome', 'postulat', 'définition', 'proposition', 'hypothèse', 'équation',
            'algèbre', 'géométrie', 'topologie', 'analyse', 'calcul', 'probabilité',
            'statistique', 'arithmétique', 'théorie des nombres', 'combinatoire', 'logique',
            'nombre premier', 'nombre entier', 'nombre réel', 'nombre complexe', 'vecteur',
            'matrice', 'déterminant', 'valeur propre', 'diagonalisation', 'espace vectoriel',
            'fonction', 'dérivée', 'intégrale', 'limite', 'série', 'suite', 'convergence',
            'groupe', 'anneau', 'corps', 'homomorphisme', 'isomorphisme', 'catégorie',
            'pythagore', 'euclide', 'fermat', 'gauss', 'euler', 'riemann', 'hilbert', 'poincaré',
            'théorème de pythagore', 'théorème de fermat', 'hypothèse de riemann', 'pi',
            'nombre d or', 'fraction continue', 'fractale', 'ensemble de mandelbrot', 'chaos',
            'pythagorean theorem', 'fermat last theorem', 'riemann hypothesis', 'prime number',
            'calculus', 'derivative', 'integral', 'linear algebra', 'group theory',
            'topology', 'manifold', 'knot theory', 'graph theory', 'number theory',
        ],
        'quality_filter': {
            'min_object_len': 6,
            'min_relation_len': 4,
