...
DOMAIN_EXPANSIONS = {
    ...
    'education': {
        ...
        'keywords': [
            'école', 'collège', 'lycée', 'université', 'étudiant', 'professeur',
            'cours', 'diplôme', 'baccalauréat', 'licence', 'master', 'doctorat',
            'programme scolaire', 'pédagogie', 'didactique', 'apprentissage', 'examen',
            'mathématiques', 'français', 'histoire', 'géographie', 'sciences',
            'éducation nationale', 'ministère éducation', 'réforme scolaire',
            'éducation', 'formation', 'enseignement', 'instruction', 'savoir',
            'compétence', 'évaluation', 'notation', 'orientation', 'bourse',
            'education', 'school', 'university', 'student', 'teacher', 'curriculum',
            'degree', 'diploma', 'exam', 'pedagogy', 'literacy', 'numeracy',
            'alphabet', 'lecture', 'écriture', 'calcul', 'grammaire', 'conjugaison',
            'socrate', 'platon', 'aristote', 'rousseau', 'montessori', 'freinet',
        ],
        'quality_filter': {
            'min_object_len': 6,
            'min_relation_len': 4,
