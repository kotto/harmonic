...
print()
    ...
    print(f"  ❌ La dérivation simple ne donne PAS 1/137.")
    print(f"     Le running QED en 1 boucle est trop faible.")
    print(f"     → α reste une CONSTANTE EMPIRIQUE dans la THU V2.")
    print(f"  ✅ La MÉTHODE (RG fractionnaire) est correcte.")
    print(f"  ⏳ Ce qui manque : le couplage nu α(M_P) dérivé de la tour,")
    print(f"     et le calcul complet à toutes les boucles avec D^{1/φ}.")
    print(f"  → FRONTIÈRE PUBLIÉE. α n'est pas dérivé à ce stade.")
