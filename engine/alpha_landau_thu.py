...
def main():
    ...
    print()
    print("  La correction fractionnaire est ~ (1/φ)/ln(M_P/m_e) ~ 10⁻³.")
    print("  → l'effet est SUBTIL mais CALCULABLE.")
    print("  → α n'est PAS dérivé de φ — mais le pôle de Landau fractionnaire")
    print("  PRÉDIT une valeur QUI PEUT ÊTRE COMPARÉE à la mesure.")
