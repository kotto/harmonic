# -*- coding: utf-8 -*-
"""
FORCE V1.2 — exécution machine du dépôt DEPOT_FORCE_V1_2.md (28/08/2026, 16:51:52)

Physique + témoin (a) VERBATIM de V1.1 (donc V1) ; seuls changements déposés :
(b) identité de normalisation PAIRE J₀ + 2ΣJ₂ₖ = 1 (parité J₋ₙ = (−1)ⁿJₙ, démontrée
dans le dépôt) ; (c) la récurrence retourne (table, J₀_brut) et le contrôle porte
sur le vrai brut ∏(2n/a) ≤ 1e23.
...
Sortie : resultat_force_v1_2.json (toutes les lectures, y compris les quasi-échecs).
"""
...
DEPOT = os.path.join(RACINE, "DEPOT_FORCE_V1_2.md")
SORTIE = os.path.join(RACINE, "resultat_force_v1_2.json")
...
print("=" * 74)
print("  FORCE V1.2 — identité paire démontrée, fermeture du guichet 2 (dépôt du 28/08/2026)")
print("=" * 74)
