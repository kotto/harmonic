...
async def test_service():
    ...
    # Test /process avec données minimales
        ...
        async with aiohttp.ClientSession() as session:
            ...
            async with session.post(
                ...
                if resp.status == 200:
                    ...
                    if latency <= 2000:
                        print(f"✓ OBJECTIF ATTEINT! ({latency:.0f}ms <= 2000ms)")
                    else:
                        print(f"✗ OBJECTIF NON ATTEINT ({latency:.0f}ms > 2000ms)")
                    ...
                    if latency > 3000:
                        ...
                        print("• Implémenter cache LRU")
                        print("• Réduire temps de simulation")
                    elif latency > 2000:
                        ...
                        print("• Ajouter cache pour améliorer")
