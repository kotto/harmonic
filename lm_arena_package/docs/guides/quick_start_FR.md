...
|---------|-----|------|-------------|
| **Dashboard Frontend** | http://localhost:8080 | 8080 | Interface utilisateur |
| **API Backend** | http://localhost:9000 | 9000 | Backend FastAPI |
