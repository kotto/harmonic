# Guide Complet LM Arena - Harmonic AI

## Table des MatiÃ¨res
1. [Introduction Ã  LM Arena](#introduction-Ã -lm-arena)
...
## Introduction Ã  LM Arena

### Qu'est-ce que LM Arena ?
LM Arena (Language Model Arena) est une plateforme d'Ã©valuation d'IA qui mesure la **prÃ©fÃ©rence humaine** entre diffÃ©rentes rÃ©ponses gÃ©nÃ©rÃ©es par des modÃ¨les de langage. Contrairement aux benchmarks traditionnels qui mesurent des mÃ©triques techniques, LM Arena se concentre sur la **qualitÃ© perÃ§ue** par les utilisateurs humains.
...
#### 2.1 Services Locaux
```bash
# Option 1 : Script de dÃ©marrage complet
start_all.bat
...
- **Support technique** : Utiliser les scripts de vÃ©rification
