#!/usr/bin/env python3
"""
Script final pour créer une instance EC2 complète pour Connective AI
"""
...
def create_complete_instance():
    ...
    # Utiliser le security group existant
    sg_id = 'sg-03c0aca646500c5a1'
    
    # Configuration de l'instance avec la bonne clé
    instance_config = {
        'ImageId': 'ami-0c02fb55956c7d316',  # Amazon Linux 2
        'InstanceType': 'm5.4xlarge',  # 16 vCPUs, 64GB RAM
        'KeyName': 'deep',  # Utiliser la clé existante
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print(f"   ssh -i \"C:\\Users\\maatc\\.ssh\\deep\" ec2-user@{result['public_ip']}")
        print("3. Lancer l'installation complète:")
        print("   bash installation_complete.sh")
        print("4. Déployer l'API complète:")
        print("   python connective_ai_complete.py")
        
        print("\n📂 Pour copier les fichiers sur l'instance:")
        print(f"scp -i \"C:\\Users\\maatc\\.ssh\\deep\" installation_complete.sh ec2-user@{result['public_ip']}:~/")
        print(f"scp -i \"C:\\Users\\maatc\\.ssh\\deep\" connective_ai_complete.py ec2-user@{result['public_ip']}:~/")
        
        print(f"\n🔑 Clé SSH utilisée: deep")
        print(f"🌐 Nouvelle IP: {result['public_ip']}")
