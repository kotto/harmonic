#!/usr/bin/env python3
"""
CRÉATION AUTOMATIQUE INSTANCE EC2 - DEEPSEEK-V4-PRO PHASE 1
===========================================================

Script pour créer automatiquement une nouvelle instance EC2
avec notre clé SSH et configuration complète Phase 1
"""
...
class EC2InstanceCreator:
    """Créateur d'instance EC2 pour Deepseek-V4-Pro"""
    ...
    def __init__(self):
        ...
        print("🚀 CRÉATION INSTANCE EC2 - DEEPSEEK-V4-PRO PHASE 1")
        print("=" * 80)
            ...
            if 'InvalidGroup.NotFound' in str(e):
                ...
                try:
                    response = self.ec2_client.create_security_group(
                        ...
                        VpcId='vpc-0d5e9b6c'  # VPC par défaut eu-west-3
                    )
    ...
    def get_iam_role_profile(self):
        ...
        print("\n🔥 ÉTAPE 2: VÉRIFICATION IAM ROLE")
        print("=" * 60)
        
        try:
            response = self.ec2_client.describe_iam_instance_profile_associations(
                Filters=[{'Name': 'instance-id', 'Values': ['i-0569cad6646c9c0f9']}]
            )
            if response['IamInstanceProfileAssociations']:
                ...
                print("⚠️ Pas de IAM Role trouvé sur l'instance existante")
                return None
        except Exception as e:
...
'''
    ...
    def wait_for_instance(self, instance_id):
        ...
        print("\n🔥 ÉTAPE 4: ATTENTE DÉMARRAGE INSTANCE")
        print("=" * 60)
...
def main():
    """Fonction principale"""
    print("🚀 CRÉATION AUTOMATIQUE INSTANCE EC2")
    print("=" * 80)
