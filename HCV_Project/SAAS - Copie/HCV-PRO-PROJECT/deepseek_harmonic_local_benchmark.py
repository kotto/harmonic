...
class DeepseekHarmonicBenchmark:
    ...
    def run_context_benchmark(self) -> dict:
        ...
        for context_size in context_sizes:
            ...
            context_prompt = f"Analyse ce contexte de {context_size} tokens: " + "x" * context_size
            
            start_time = time.time()
            
            # Générer une réponse
            response = self.harmonic_layer.generate_deterministic_response(context_prompt[:1000], max_tokens=100)
        ...
        self.log(f"   ✅ Contexte: {context_grade} (max: {max_context_supporte:,} tokens)")
    ...
    def generate_competitive_analysis(self) -> dict:
        ...
        deepseek_advantages = [
            ...
            f"{our_results['context_tokens']:,} tokens contexte (maximum du marché)",
    ...
    def save_results(self) -> Path:
        ...
        self.results['model_info'] = {
            ...
            'harmonic_constants': self.harmonic_layer.harmonic_constants,
