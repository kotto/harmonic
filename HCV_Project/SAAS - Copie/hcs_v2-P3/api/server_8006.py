#!/usr/bin/env python3
"""
HCS V2 API Server - Version port 8006 pour éviter les conflits
"""
...
if __name__ == "__main__":
    print("🚀 Démarrage HCS V2 API Server (Port 8006)")
    print("=" * 60)
    print("📊 Configuration:")
    ...
    print("   http://localhost:8006/redoc")
    print("   http://localhost:8006/api/v2/compress/image")
    print("   http://localhost:8006/api/v2/compress/video")
    print("   http://localhost:8006/api/v2/stats")
    print("   http://localhost:8006/api/v2/health")
    print("   http://localhost:8006/hcs_dashboard_v2")
    print()
    
    uvicorn.run(
        app,
        host="0.0.0.0",
        port=8006,  # Port 8006 pour éviter les conflits
        reload=False,
        log_level="info"
    )
