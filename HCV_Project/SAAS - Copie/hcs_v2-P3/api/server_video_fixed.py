#!/usr/bin/env python3
"""
HCS V2 API Server - Version avec ratios vidéo corrigés
"""
...
if __name__ == "__main__":
    print("🚀 Démarrage HCS V2 API Server (Version Vidéo Corrigée)")
    print("=" * 60)
    print("📊 Configuration:")
    ...
    print("   http://localhost:8004/redoc")
    print("   http://localhost:8004/api/v2/compress/image")
    print("   http://localhost:8004/api/v2/compress/video")
    print("   http://localhost:8004/api/v2/stats")
    print("   http://localhost:8004/api/v2/health")
    print("   http://localhost:8004/dashboard_final")
    print()
    
    uvicorn.run(
        app,
        host="0.0.0.0",
        port=8004,  # Nouveau port pour éviter les conflits
        reload=False,
        log_level="info"
    )
