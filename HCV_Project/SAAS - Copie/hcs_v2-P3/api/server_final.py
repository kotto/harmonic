#!/usr/bin/env python3
"""
HCS V2 API Server - Version Finale avec tous les endpoints et corrections
...
if __name__ == "__main__":
    print("🚀 Démarrage HCS V2 API Server (Version Finale)")
    print("=" * 60)
    print("📊 Configuration:")
    ...
    print("   http://localhost:8002/redoc")
    print("   http://localhost:8002/api/v2/compress/image")
    print("   http://localhost:8002/api/v2/compress/video")
    print("   http://localhost:8002/api/v2/stats")
    print("   http://localhost:8002/api/v2/health")
    print("   http://localhost:8002/frontend/dashboard_fixed.html")
    print()
