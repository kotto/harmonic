"""
HCV PRO - OpenClaw Integration
Stub local — remplace le package 'openclaw' inexistant sur PyPI.

Expose les métriques système réelles (CPU, RAM, handles ouverts)
via psutil. Étendre ici pour brancher un vrai service OpenClaw
...
class OpenClawService:
    """
    Service d'intégration OpenClaw.
    ...
    def start(self):
        ...
        self._thread.start()
        print("🦅 OpenClawService démarré (métriques système).")
    ...
    def _poll_loop(self):
        ...
        while self._running:
            try:
                ...
                print(f"[OpenClaw] Erreur collecte métriques : {e}")
